    ...
    switch(piece) {
        case 'pawn' : 
            ...
            if (
                ...
                startId + width === targetId && !target.firstElementChild ||
        ...
        case 'bishop': 
            if (
                ...
                startId + width * 3 + 3 === targetId && !document.querySelector(`[square-id="${startId + width + 1}"]`).firstElementChild && !document.querySelector(`[square-id="${startId + width * 2 + 2}"]`).firstElementChild ||
                startId + width * 4 + 4 === targetId && !document.querySelector(`[square-id="${startId + width + 1}"]`).firstElementChild && !document.querySelector(`[square-id="${startId + width * 2 + 2}"]`).firstElementChild && !document.querySelector(`[square-id="${startId + width * 3 + 3}"]`).firstElementChild ||
                startId + width * 5 + 5 === targetId && !document.querySelector(`[square-id="${startId + width + 1}"]`).firstElementChild && !document.querySelector(`[square-id="${startId + width * 2 + 2}"]`).firstElementChild && !document.querySelector(`[square-id="${startId + width * 3 + 3}"]`).firstElementChild && !document.querySelector(`[square-id="${startId + width * 4 + 4}"]`).firstElementChild ||
